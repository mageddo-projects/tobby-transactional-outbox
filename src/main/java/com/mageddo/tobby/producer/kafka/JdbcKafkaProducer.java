...
public class JdbcKafkaProducer<K, V> {
  ...
  private final InterceptableProducer delegate;
  private final Serializer<K> keySerializer;
  private final Serializer<V> valueSerializer;

  public JdbcKafkaProducer(InterceptableProducer delegate, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
