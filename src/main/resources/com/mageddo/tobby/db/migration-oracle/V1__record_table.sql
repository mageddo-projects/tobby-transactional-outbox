CREATE TABLE TTO_RECORD (
    ...
    NUM_PARTITION NUMBER(3, 0),
    IND_STATUS VARCHAR2(8),
    IND_AGENT VARCHAR2(8),
    TXT_KEY CLOB,
    TXT_VALUE CLOB,
    TXT_HEADERS CLOB,
...
CREATE INDEX TTO_RECORD_PROCESSED_IDX2 ON TTO_RECORD_PROCESSED(IND_STATUS, DAT_CREATED);
